    ...
    <div className="min-h-screen bg-app flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-10">
        <div className="text-center mb-6 flex flex-col items-center">
          <div className="h-14 px-4 py-2 mb-3 rounded-xl bg-surface border border-line shadow-sm flex items-center justify-center">
            <img
              src="./logo.png"
              alt="PulseLine Logo"
              className="h-full w-auto object-contain dark:invert dark:brightness-125"
            />
          </div>
          <p className="text-[11px] font-medium uppercase tracking-[0.14em] text-muted mb-1">
